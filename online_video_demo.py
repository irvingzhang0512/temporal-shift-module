...
def _parse_args():
    ...
    parser.add_argument('--input-video', type=str,
                        default="/ssd4/zhangyiyang/temporal-shift-module/data/test.mp4")
    parser.add_argument('--input-frame-interval', type=int, default=2)
    parser.add_argument('--output-video', type=str,
                        default="/ssd4/zhangyiyang/temporal-shift-module/data/test-output.mp4")
    ...
    parser.add_argument('--model-ckpt-path', type=str,
                        default="/ssd4/zhangyiyang/temporal-shift-module/checkpoint/TSM_jester_RGB_mobilenetv2_shift8_blockres_avg_segment8_e50/ckpt.best.pth.tar")
...
def load_model(args):
    ...
    model.eval()
    checkpoint = torch.load(args.model_ckpt_path)
