...
def main():
    ...
    cap = cv2.VideoCapture("/ssd4/zhangyiyang/temporal-shift-module/data/input/jester.mp4")
    # fourcc = cv2.VideoWriter_fourcc(* 'XVID')
    # writer = cv2.VideoWriter(
    #     os.path.join("/ssd4/zhangyiyang/temporal-shift-module/data/output/tvm.avi"),
    #     fourcc,
    #     25,
    #     (640, 480),
    # )
