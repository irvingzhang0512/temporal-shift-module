...
def _parse_args():
    ...
    parser.add_argument("--lib-file-path", type=str,
                        default="./logs-gpu-jetbot-mobilenetv2_online-1589961530653/deploy_lib.tar")
    parser.add_argument("--graph-file-path", type=str,
                        default="./logs-gpu-jetbot-mobilenetv2_online-1589961530653/deploy_graph.json")
    parser.add_argument("--params-file-path", type=str,
                        default="./logs-gpu-jetbot-mobilenetv2_online-1589961530653/deploy_param.params")
